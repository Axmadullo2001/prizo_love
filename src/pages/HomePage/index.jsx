...
import {Navigation, Thumbs, Scrollbar, A11y} from 'swiper'
...
import best_offers from '../../assets/images/Store/best_offers.png'
      ...
      <div className={s.home_page__main_container}>
        <section className={s.home_page__section}>
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2144)">
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2169)">
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2196)">
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2240)">
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2262)">
          ...
          <div className={s.home_page__list}>
            <p>
              <svg className={s.home_page__navbar_icon} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.5" clipPath="url(#clip0_256_2281)">
        ...
        <main className={s.home_page__main}>
            ...
            <div className={s.home_page__incart_right_part}>
              ...
              <button>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g opacity="0.5" clipPath="url(#clip0_257_81)">
          ...
          <div className={s.home_page__best_offers}>
            <div className={s.home_page__title_offers}>
              <h2>Лучшие ценовые предложения</h2>
              <sup>52 товара</sup>
            </div>

            <div className={s.home_page__card_container}>
              <div className={s.home_page__card_item}>
                <img width={159} height={159} src={best_offers} alt="" />
                <p className={s.home_page__title_card}>Пилосос SAMSUNG Step-up VC07R302MVR/UK Red</p>

                <div className={s.home_page__change_money}>
                  <div className={s.home_page__grade_block}>
                    <button>
                      <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.0208 5.44528L11.1009 8.29153L11.7904 12.3115C11.8204 12.4873 11.7483 12.665 11.6039 12.77C11.5223 12.8295 11.4253 12.8595 11.3283 12.8595C11.2537 12.8595 11.1787 12.8417 11.1103 12.8056L7.49998 10.9076L3.89014 12.8051C3.73264 12.8886 3.54092 12.875 3.39654 12.7695C3.25217 12.6645 3.17998 12.4868 3.20998 12.3111L3.89951 8.29106L0.979201 5.44528C0.851701 5.3206 0.805294 5.13403 0.860607 4.96481C0.915919 4.7956 1.06264 4.67138 1.23936 4.6456L5.27483 4.05966L7.07951 0.402471C7.23748 0.0823144 7.76248 0.0823144 7.92045 0.402471L9.72514 4.05966L13.7606 4.6456C13.9373 4.67138 14.084 4.79513 14.1394 4.96481C14.1947 5.1345 14.1483 5.32013 14.0208 5.44528V5.44528Z" fill="#FAA525" />
                      </svg>
                    </button>
                    <button>
                      <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button>
                      <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.0208 5.44528L11.1009 8.29153L11.7904 12.3115C11.8204 12.4873 11.7483 12.665 11.6039 12.77C11.5223 12.8295 11.4253 12.8595 11.3283 12.8595C11.2537 12.8595 11.1787 12.8417 11.1103 12.8056L7.49998 10.9076L3.89014 12.8051C3.73264 12.8886 3.54092 12.875 3.39654 12.7695C3.25217 12.6645 3.17998 12.4868 3.20998 12.3111L3.89951 8.29106L0.979201 5.44528C0.851701 5.3206 0.805294 5.13403 0.860607 4.96481C0.915919 4.7956 1.06264 4.67138 1.23936 4.6456L5.27483 4.05966L7.07951 0.402471C7.23748 0.0823144 7.76248 0.0823144 7.92045 0.402471L9.72514 4.05966L13.7606 4.6456C13.9373 4.67138 14.084 4.79513 14.1394 4.96481C14.1947 5.1345 14.1483 5.32013 14.0208 5.44528V5.44528Z" fill="#E3E3E3" />
                      </svg>
                    </button>
                    <button>
                      <svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g opacity="0.5" clipPath="url(#clip0_257_138)">
                        <path d="M8.46875 10.2796C9.00766 10.1472 9.40625 9.80033 9.40625 9.40168C9.40625 9.00302 9.00766 8.65615 8.46875 8.5238V10.2796Z" fill="#494949" />
                        <path d="M8 2.84375C5.15684 2.84375 2.84375 5.15684 2.84375 8C2.84375 10.8432 5.15684 13.1562 8 13.1562C10.8432 13.1562 13.1562 10.8432 13.1562 8C13.1562 5.15684 10.8432 2.84375 8 2.84375ZM10.3438 9.40169C10.3438 10.3073 9.53722 11.0646 8.46875 11.2388V11.75C8.46875 12.0091 8.25909 12.2188 8 12.2188C7.74091 12.2188 7.53125 12.0091 7.53125 11.75V11.2388C6.46278 11.0646 5.65625 10.3073 5.65625 9.40169C5.65625 9.14259 5.86591 8.93294 6.125 8.93294C6.38409 8.93294 6.59375 9.14259 6.59375 9.40169C6.59375 9.80034 6.99234 10.1472 7.53125 10.2796V8.42625C6.46278 8.25206 5.65625 7.49481 5.65625 6.58919C5.65625 5.68356 6.46278 4.92631 7.53125 4.75212V4.24544C7.53125 3.98634 7.74091 3.77669 8 3.77669C8.25909 3.77669 8.46875 3.98634 8.46875 4.24544V4.75212C9.53722 4.92631 10.3438 5.68356 10.3438 6.58919C10.3438 6.84828 10.1341 7.05794 9.875 7.05794C9.61591 7.05794 9.40625 6.84828 9.40625 6.58919C9.40625 6.19053 9.00766 5.84366 8.46875 5.71131V7.56462C9.53722 7.73878 10.3438 8.49603 10.3438 9.40169Z" fill="#494949" />
                        <path d="M7.53125 5.7113C6.99234 5.84365 6.59375 6.19052 6.59375 6.58918C6.59375 6.98783 6.99234 7.33471 7.53125 7.46705V5.7113Z" fill="#494949" />
                        <path d="M8 0C3.60594 0 0 3.60594 0 8C0 12.3941 3.60594 16 8 16C12.3941 16 16 12.3941 16 8C16 3.60594 12.3941 0 8 0ZM8 14.0938C4.64 14.0938 1.90625 11.36 1.90625 8C1.90625 4.64 4.64 1.90625 8 1.90625C11.36 1.90625 14.0938 4.64 14.0938 8C14.0938 11.36 11.36 14.0938 8 14.0938Z" fill="#494949" />
                      </g>
                      <defs>
                ...
                <div className={s.home_page__discount_box}>
                  <p className={s.home_page__real_price}>9 999 ₴</p>
                  <p className={s.home_page__discount_price}>-1 000</p>
                </div>
                <div className={s.home_page__real_price_box}>
                  <p className={s.home_page__overall_price}>8 999 ₴</p>
                  <button className={s.home_page__add_to_basket_btn}>
                    <svg className={s.home_page__basket_icon} width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M7.5625 15.0312C8.33915 15.0312 8.96875 14.4017 8.96875 13.625C8.96875 12.8483 8.33915 12.2188 7.5625 12.2188C6.78585 12.2188 6.15625 12.8483 6.15625 13.625C6.15625 14.4017 6.78585 15.0312 7.5625 15.0312Z" fill="white" />
                      <path d="M12.2812 15.0312C13.0578 15.0312 13.6874 14.4017 13.6874 13.625C13.6874 12.8483 13.0578 12.2188 12.2812 12.2188C11.5045 12.2188 10.8749 12.8483 10.8749 13.625C10.8749 14.4017 11.5045 15.0312 12.2812 15.0312Z" fill="white" />
                      <path d="M0.968747 1.90628H2.92352L5.18657 9.82851L5.00907 10.1835C4.5417 11.1172 5.22016 12.2187 6.267 12.2187H14.1562C14.4153 12.2187 14.6249 12.0091 14.6249 11.75C14.6249 11.4909 14.4153 11.2812 14.1562 11.2812H6.267C5.91891 11.2812 5.69141 10.9147 5.84769 10.6028L5.97725 10.3437H14.1562C14.3654 10.3437 14.5494 10.205 14.6071 10.0036L16.4821 3.44114C16.5223 3.2997 16.494 3.14771 16.4056 3.03008C16.3168 2.91289 16.1781 2.84377 16.0312 2.84377H4.16632L3.72779 1.30887C3.67011 1.10747 3.48611 0.96875 3.27689 0.96875H0.968747C0.709655 0.96875 0.5 1.1784 0.5 1.4375C0.5 1.69659 0.709655 1.90628 0.968747 1.90628V1.90628Z" fill="white" />
                    </svg>
                    <span className={s.home_page__add_basket_text}>В корзину</span>
                  </button>
                </div>
